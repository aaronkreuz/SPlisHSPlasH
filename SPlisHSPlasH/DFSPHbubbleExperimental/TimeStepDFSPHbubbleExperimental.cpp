#include "TimeStepDFSPHbubbleExperimental.h"
...
int TimeStepDFSPHbubbleExperimental::SOLVER_ITERATIONS_V = -1;
int TimeStepDFSPHbubbleExperimental::MAX_ITERATIONS_V = -1;
int TimeStepDFSPHbubbleExperimental::MAX_ERROR_V = -1;
int TimeStepDFSPHbubbleExperimental::USE_DIVERGENCE_SOLVER = -1;
int TimeStepDFSPHbubbleExperimental::SOLVER_ITERATIONS_AIR = -1;
int TimeStepDFSPHbubbleExperimental::SOLVER_ITERATIONS_LIQ = -1;
int TimeStepDFSPHbubbleExperimental::SOLVER_ITERATIONS_V_AIR = -1;
...
int TimeStepDFSPHbubbleExperimental::VT_TRAPPED_AIR = -1;
int TimeStepDFSPHbubbleExperimental::VDIFF_THRESHOLD_MIN = -1;
int TimeStepDFSPHbubbleExperimental::VDIFF_THRESHOLD_MAX = -1;
int TimeStepDFSPHbubbleExperimental::MAX_AIR_PARTICLES_PER_STEP = -1;
...
int TimeStepDFSPHbubbleExperimental::ENUM_TRAPPED_AIR_APPROACH_IHMSEN2012 = -1;
int TimeStepDFSPHbubbleExperimental::ENUM_TRAPPED_AIR_APPROACH_CAVITATION = -1;


TimeStepDFSPHbubbleExperimental::TimeStepDFSPHbubbleExperimental() :
	TimeStep(),
	m_simulationData()
{
...
void TimeStepDFSPHbubbleExperimental::trappedAirIhmsen2012(unsigned int& emittedParticles, std::vector<unsigned int>& indicesGen)
{
...
void SPH::TimeStepDFSPHbubbleExperimental::trappedAirCavitation(const unsigned int liquidModelIndex, const unsigned int i, unsigned int& emittedParticles, std::vector<unsigned int>& indicesGen)
{
	Simulation* sim = Simulation::getCurrent();
	FluidModel* airModel = sim->getFluidModel(1)->getId() == "Air" ? sim->getFluidModel(1) : sim->getFluidModel(0);
	FluidModel* model = sim->getFluidModel(liquidModelIndex); 	// liquid model -> naming convention for makros
...
void TimeStepDFSPHbubbleExperimental::divergenceSolve()
{
	//////////////////////////////////////////////////////////////////////////
	// Init parameters
	//////////////////////////////////////////////////////////////////////////
...
void TimeStepDFSPHbubbleExperimental::reset()
{
	TimeStep::reset();
...
void TimeStepDFSPHbubbleExperimental::resize()
{
	m_simulationData.init();
}
...
void TimeStepDFSPHbubbleExperimental::computeDFSPHFactor(const unsigned int fluidModelIndex)
{
	//////////////////////////////////////////////////////////////////////////
	// Init parameters
	//////////////////////////////////////////////////////////////////////////
...
/** Compute rho_adv,i^(0) (see equation in Section 3.3 in [BK17])
  * using the velocities after the non-pressure forces were applied.
**/
void TimeStepDFSPHbubbleExperimental::computeDensityAdv(const unsigned int fluidModelIndex, const unsigned int i, const Real h, const Real density0)
{
	Simulation* sim = Simulation::getCurrent();
	FluidModel* model = sim->getFluidModel(fluidModelIndex);
	const Real& density = model->getDensity(i);
...
/** Compute pressure accelerations using the current pressure values of the particles
 */
void TimeStepDFSPHbubbleExperimental::computePressureAccel(const unsigned int fluidModelIndex, const unsigned int i, const Real density0, std::vector<std::vector<Real>>& pressure_rho2, const bool applyBoundaryForces)
{
	Simulation* sim = Simulation::getCurrent();
	FluidModel* model = sim->getFluidModel(fluidModelIndex);
	const unsigned int nFluids = sim->numberOfFluidModels();
...
Real TimeStepDFSPHbubbleExperimental::compute_aij_pj(const unsigned int fluidModelIndex, const unsigned int i)
{
	Simulation* sim = Simulation::getCurrent();
	FluidModel* model = sim->getFluidModel(fluidModelIndex);
	const unsigned int nFluids = sim->numberOfFluidModels();
...
void TimeStepDFSPHbubbleExperimental::computeCohesionForce(const unsigned int fluidModelIndex, const Real h) {
	Simulation* sim = Simulation::getCurrent();
	FluidModel* model = sim->getFluidModel(fluidModelIndex);
	unsigned int nFluids = sim->numberOfFluidModels();
	unsigned int numParticles = model->numActiveParticles();
