#ifndef __TimeStepDFSPHbubbleExperimental_h__
#define __TimeStepDFSPHbubbleExperimental_h__
...
namespace SPH
{
	class SimulationDataDFSPHbubbleExperimental;
	...
	*/
	class TimeStepDFSPHbubbleExperimental : public TimeStep
	{
	protected:
		SimulationDataDFSPHbubbleExperimental m_simulationData;
