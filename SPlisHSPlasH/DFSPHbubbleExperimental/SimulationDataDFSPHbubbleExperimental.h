#ifndef __SimulationDataDFSPHbubbleExperimental_h__
#define __SimulationDataDFSPHbubbleExperimental_h__
...
{	
	...
	*/
	...
	{
		public:
			SimulationDataDFSPHbubbleExperimental();
			virtual ~SimulationDataDFSPHbubbleExperimental();
