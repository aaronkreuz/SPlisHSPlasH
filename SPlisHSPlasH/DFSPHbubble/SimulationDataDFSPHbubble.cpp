...
SimulationDataDFSPHbubble::SimulationDataDFSPHbubble(void) :
	m_factor(),
	m_pressure(),
	m_pressure_V(),
	m_source_term(),
...
void SimulationDataDFSPHbubble::init()
{
...
void SimulationDataDFSPHbubble::cleanup()
{
	Simulation* sim = Simulation::getCurrent();
...
void SimulationDataDFSPHbubble::reset()
{
	Simulation* sim = Simulation::getCurrent();
	const unsigned int nModels = sim->numberOfFluidModels();
...
void SimulationDataDFSPHbubble::performNeighborhoodSearchSort()
{
	Simulation* sim = Simulation::getCurrent();
	const unsigned int nModels = sim->numberOfFluidModels();
...
void SimulationDataDFSPHbubble::emittedParticles(FluidModel *model, const unsigned int startIndex)
{
