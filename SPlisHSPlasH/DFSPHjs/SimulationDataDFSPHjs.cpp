...
SimulationDataDFSPHjs::SimulationDataDFSPHjs(void) :
	m_factor(),
	m_pressure(),
	m_pressure_V(),
	m_source_term(),
...
void SimulationDataDFSPHjs::init()
{
...
void SimulationDataDFSPHjs::cleanup()
{
	Simulation* sim = Simulation::getCurrent();
...
void SimulationDataDFSPHjs::reset()
{
	Simulation* sim = Simulation::getCurrent();
	const unsigned int nModels = sim->numberOfFluidModels();
...
void SimulationDataDFSPHjs::performNeighborhoodSearchSort()
{
	Simulation* sim = Simulation::getCurrent();
	const unsigned int nModels = sim->numberOfFluidModels();
...
void SimulationDataDFSPHjs::emittedParticles(FluidModel *model, const unsigned int startIndex)
{
