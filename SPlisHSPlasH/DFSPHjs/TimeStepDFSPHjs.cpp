...
int TimeStepDFSPHjs::SOLVER_ITERATIONS_V = -1;
int TimeStepDFSPHjs::MAX_ITERATIONS_V = -1;
int TimeStepDFSPHjs::MAX_ERROR_V = -1;
int TimeStepDFSPHjs::USE_DIVERGENCE_SOLVER = -1;


TimeStepDFSPHjs::TimeStepDFSPHjs() :
	TimeStep(),
	m_simulationData()
{
...
TimeStepDFSPHjs::~TimeStepDFSPHjs(void)
{
...
void TimeStepDFSPHjs::initParameters()
{
...
void TimeStepDFSPHjs::computeViscosityForce(const unsigned int fluidModelIndex, const unsigned i, const Real h) {
	Simulation* sim = Simulation::getCurrent();
	FluidModel* fm = Simulation::getCurrent()->getFluidModel(fluidModelIndex);
...
void TimeStepDFSPHjs::pressureSolve(){
	Simulation* sim = Simulation::getCurrent();
	const unsigned int nFluids = sim->numberOfFluidModels();
	TimeManager* tm = TimeManager::getCurrent();
	const Real h = tm->getTimeStepSize();
...
void TimeStepDFSPHjs::divergenceSolve()
{
	Simulation* sim = Simulation::getCurrent();
	const unsigned int nFluids = sim->numberOfFluidModels();
...
void TimeStepDFSPHjs::performNeighborhoodSearch()
{
...
void TimeStepDFSPHjs::emittedParticles(FluidModel *model, const unsigned int startIndex)
{
	m_simulationData.emittedParticles(model, startIndex);
}

void TimeStepDFSPHjs::resize()
{
	m_simulationData.init();
}
 ...
 */
void TimeStepDFSPHjs::computePressureAccel(const unsigned int fluidModelIndex, const unsigned int i, const Real density0, const std::vector<std::vector<Real>>& pressureList, const bool applyBoundaryForces)
{
	Simulation* sim = Simulation::getCurrent();
	FluidModel* model = sim->getFluidModel(fluidModelIndex);
	const unsigned int nFluids = sim->numberOfFluidModels();
...
void TimeStepDFSPHjs::compute_aii(const unsigned int fluidModelIndex, const unsigned int i, const Real h){
	Simulation* sim = Simulation::getCurrent();
	FluidModel* model = sim->getFluidModel(fluidModelIndex);
	const unsigned int nFluids = sim->numberOfFluidModels();
...
Real TimeStepDFSPHjs::compute_aij_pj(const unsigned int fluidModelIndex, const unsigned int i)
{
	Simulation* sim = Simulation::getCurrent();
	FluidModel* model = sim->getFluidModel(fluidModelIndex);
	const Real h = TimeManager::getCurrent()->getTimeStepSize();
...
void TimeStepDFSPHjs::computeConstantDensitySourceTerm (const unsigned int fluidModelIndex, const unsigned int i, const Real h){
...
void TimeStepDFSPHjs::computeDivergenceSourceTerm(const unsigned int fluidModelIndex, const unsigned int i, const Real h){
	Simulation* sim = Simulation::getCurrent();
	FluidModel* model = sim->getFluidModel(fluidModelIndex);
	const unsigned int nFluids = sim->numberOfFluidModels();
	const Vector3r& xi = model->getPosition(i);
