...
{
	m_cohesionCoefficient = static_cast<Real>(8.0);
	m_dragConstantAir = static_cast<Real>(8.0);
	m_dragConstantLiq = static_cast<Real>(3.0);
	m_kmaxBuoyancy = static_cast<Real>(6.0);
	m_minBuoyancy = static_cast<Real>(2.4);
}
