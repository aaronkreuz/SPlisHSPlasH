...
SimulationDataPCISPHbubble::SimulationDataPCISPHbubble()
{
}

SimulationDataPCISPHbubble::~SimulationDataPCISPHbubble(void)
{
	cleanup();
}

void SimulationDataPCISPHbubble::init()
{
...
void SimulationDataPCISPHbubble::cleanup()
{
	m_predX.clear();
	m_predV.clear();
	m_densityAdv.clear();
...
void SimulationDataPCISPHbubble::reset()
{
}

void SimulationDataPCISPHbubble::performNeighborhoodSearchSort()
{
	Simulation *sim = Simulation::getCurrent();
	const unsigned int nModels = sim->numberOfFluidModels();
...
void SimulationDataPCISPHbubble::emittedParticles(FluidModel *model, const unsigned int startIndex)
{
